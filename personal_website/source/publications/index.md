...
- Developed an automated evaluation pipeline measuring proof validity and functional correctness alongside Dr. Dawn Song and Dr. Kaiyu Yang, revealing that state-of-the-art code agents achieve single-digit success rates on VeriAgentBench.
...
**Key Contributions**:
- Introduced a reinforcement learning-based framework to enable adaptive and integrated operations management in healthcare facilities.
- Built a smart building management system for the Cardiac Catheterization Lab at St. Bernardine Medical Center with Dr. Yehuda Kalay and Dr. Davide Schaumann, significantly enhancing facility adaptability and operational efficiency.
